...
INSERT INTO classes (code,subject_id,room,is_full)
VALUES 
   ("A-111-01","S-123-AB",10,0),
   ("A-121-02","S-111-AB",12,0),
   ("B-101-01","S-012-CB",9,0),
   ("B-102-03","S-188-CB",12,0),
   ("C-100-02","S-001-DX",1,1);
SELECT * FROM classes;
